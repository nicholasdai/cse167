...
export function AppLayoutSplitPanelDrawerBottomImplementation({ children, splitPanelInternals, appLayoutInternals, }) {
    return (React.createElement(SplitPanelProvider, Object.assign({}, splitPanelInternals, { animationDisabled: appLayoutInternals.splitPanelAnimationDisabled }), children));
}
