...
export function TableHeaderSelectionCell(_a) {
    ...
    return (React.createElement(TableThElement, Object.assign({}, props, { isSelection: true, colIndex: 0, focusedComponent: focusedComponent }),
        getSelectAllProps ? (React.createElement(SelectionControl, Object.assign({ onFocusDown: event => {
                onFocusMove(event.target, -1, +1);
            }, focusedComponent: focusedComponent }, getSelectAllProps(), (props.sticky ? { tabIndex: -1 } : {})))) : (React.createElement(ScreenreaderOnly, null, singleSelectionHeaderAriaLabel)),
...
export function TableBodySelectionCell(_a) {
    ...
    return (React.createElement(TableTdElement, Object.assign({}, props, { isSelection: true, wrapLines: false, isEditable: false, isEditing: false, colIndex: 0 }), selectionControlProps ? React.createElement(SelectionControl, Object.assign({}, selectionControlProps)) : null));
}
