...
.awsui_tutorial-box_ig8mp_1014l_250:not(#\9) {
  ...
  -moz-osx-font-smoothing: auto;
  list-style: none;
  border-block: var(--border-divider-section-width-1061zr, 1px) solid var(--color-border-tutorial-upbl0e, #dedee3);
  border-inline: var(--border-divider-section-width-1061zr, 1px) solid var(--color-border-tutorial-upbl0e, #dedee3);
